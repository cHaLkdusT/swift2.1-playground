...
//: # Numeric Literals
let decimaInteger = 17 // no prefix
let binaryInteger = 0b10001 // with 0b prefix
let octalInteger = 0o21 // with 0o prefix
let hexdecimalInteger = 0x11 // with 0x prefix
...
let justOverOneMillion = 00001_000_000.000_000_1
