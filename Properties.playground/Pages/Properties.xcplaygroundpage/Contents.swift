...
/*:
A _lazy stored property_ is a property whose initiali value is not calculated until the first time it is used. You indicate a lazy stored property by writing the `lazy` modifier before it declaration.
