...
You cna present an inherited read-only property as read-write property by providing both a getter and setter in your subclass property override. You cannot, however, present an inherited read-write property as read-only property
*/
class Car: Vehicle {
    var gear = 1
...
//: Move on to [Preventing Override](@next)
