...
/*:
_Control transfer statemetns change the order in which your code is executed, by transferring control from one piece of code to another. Swifth has five control transfer statements:
